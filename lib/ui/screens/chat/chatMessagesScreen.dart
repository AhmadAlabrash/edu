...
import 'package:e_demand/cubits/chat/chatMessagesCubit.dart';
import 'package:e_demand/cubits/chat/chatUsersCubit.dart';
...
import 'package:e_demand/ui/screens/chat/widgets/attachmentBottomsheetWidget.dart';
import 'package:e_demand/ui/screens/chat/widgets/messageSendingWidget.dart';
import 'package:e_demand/ui/screens/chat/widgets/singleMessageItem.dart';
import 'package:e_demand/utils/dateTimeExtension.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                              ...
                              ? widget.chatUser.bookingStatus?.toLowerCase() != "cancelled" &&
                                  ...
                                  : Center(
                                      child: NoDataContainer(
                                          titleKey:
                                              "noChatHistoryFound".translate(context: context)))
                              : ListView.builder(
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        SingleChatMessageItem(
                                          ...
                                          isError:
                                              state.errorIds.contains(state.chatMessages[index].id),
            ...
            if (widget.chatUser.bookingStatus?.toLowerCase() != "cancelled" &&
                widget.chatUser.bookingStatus?.toLowerCase() != "completed") ...[
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (chatPredefineMessagesForProvider.isNotEmpty &&
                widget.chatUser.receiverType == "1") ...[
              SizedBox(
                height: 20,
              ),
              ListView.separated(
                shrinkWrap: true,
                itemCount: chatPredefineMessagesForProvider.length,
                itemBuilder: (context, index) {
                  return _buildPredefineMessageWidget(
                    message: chatPredefineMessagesForProvider[index],
                  );
                },
            ...
            if (chatPredefineMessagesForAdmin.isNotEmpty &&
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return _buildPredefineMessageWidget(
                    message: chatPredefineMessagesForAdmin[index],
                  );
                },
                separatorBuilder: (context, index) => SizedBox(
                  height: 10,
  ...
  Widget _buildPredefineMessageWidget({required String message}) {
    return GestureDetector(
      ...
      child: Align(
        ...
        child: CustomContainer(
          color: Theme.of(context).colorScheme.accentColor.withOpacity(0.1),
          borderRadius: 12,
