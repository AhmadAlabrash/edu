...
class _ImagesFullScreenState extends State<ImagesFullScreen> {
  ...
  _adjustBottomItemScroll({required int currentItemIndex}) {
  ...
  Widget _topWidget() {
    return Container(
      padding: EdgeInsetsDirectional.only(
          top: MediaQuery.of(context).viewPadding.top, bottom: 15, start: 15, end: 15),
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            if (shareDownloadLoading)
              SizedBox(height: 20, width: 20, child: CustomCircularProgressIndicator())
          ],
        ),
      ),
    );
