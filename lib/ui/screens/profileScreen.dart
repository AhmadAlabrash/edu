                      ...
                      child: Column(
                        children: [
                            ...
                            onTap: () {
                              try {
                                if (Platform.isAndroid) {
                                  ...
                                  Share.share(context.read<SystemSettingCubit>().getAppURL(
                                      typesOfAppURLs: TypesOfAppURLs.CUSTOMER_APP_PLAYSTORE_URL));
                                } else {
                                  Share.share(context.read<SystemSettingCubit>().getAppURL(
                                      typesOfAppURLs: TypesOfAppURLs.CUSTOMER_APP_APPSTORE_URL));
                                }
                              } catch (e) {
                                UiUtils.showMessage(
                                  context,
                            ...
                            onTap: () async {
                              {
                                if (Platform.isAndroid) {
                                  // ignore: prefer_interpolation_to_compose_strings
                                  String playstoreURL = context
                                      .read<SystemSettingCubit>()
                                      .getAppURL(
                                          typesOfAppURLs:
                                              TypesOfAppURLs.CUSTOMER_APP_PLAYSTORE_URL);
                                  ...
                                  String appstoreURL = context.read<SystemSettingCubit>().getAppURL(
                                      typesOfAppURLs: TypesOfAppURLs.CUSTOMER_APP_APPSTORE_URL);
                          ...
                          _getListItem(
                            ...
                            onTap: () async {
                              if (Platform.isAndroid) {
                                String providerPlayStoreURL = context
                                    .read<SystemSettingCubit>()
                                    .getAppURL(
                                        typesOfAppURLs: TypesOfAppURLs.PROVIDER_APP_PLAYSTORE_URL);
                                if (await canLaunchUrl(Uri.parse(providerPlayStoreURL))) {
                                  try {
                                    launchUrl(Uri.parse(providerPlayStoreURL),
                                        mode: LaunchMode.externalApplication);
                                  } catch (e) {
                                    UiUtils.showMessage(
                                      context,
                                ...
                                String providerAppStoreURL = context
                                    .read<SystemSettingCubit>()
                                    .getAppURL(
                                        typesOfAppURLs: TypesOfAppURLs.PROVIDER_APP_APPSTORE_URL);

                                if (await canLaunchUrl(Uri.parse(providerAppStoreURL))) {
                                  try {
                                    launchUrl(Uri.parse(providerAppStoreURL),
                                        mode: LaunchMode.externalApplication);
                                  } catch (e) {
                                    UiUtils.showMessage(
                                      context,
